    ...
    try {
        function component(object) {
            this.initialize = function() {
                ...
                scroll.body().append('<div>Kinoger Test Menu (v6)</div>');
        ...
        function startPlugin() {
            ...
            if (typeof Lampa !== 'undefined' && Lampa.Component && Lampa.Menu) {
                Lampa.Component.add('kinoger_test_v6', component);
                Lampa.Menu.add('kinoger_test_menu_v6', {
                    title: 'Kinoger Test Menu v6',
                    url: 'plugin/kinoger_test_v6',
                    type: 'catalog'
                });
